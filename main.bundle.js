...
module.exports = "<div>\n  <div class=\"height-fix\" style=\"border:1px solid transparent;\">\n    <div class=\"jumbotron jumbotron-fix\">\n      <div class=\"\">\n        <div class=\"header-content pad-sides\">\n          <resume-header></resume-header>\n          <resume-about></resume-about>\n        </div>\n        <resume-skills [offsetHeight]=\"headerContentHeight\" (skillHeight)=\"setSkillHeight($event)\"></resume-skills>\n      </div>\n    </div>\n  </div>\n  <div class=\"table-default\">\n    <div class=\"container\">\n      <resume-projects [offsetHeight]=\"headerContentHeight-skillsHeight+6\"></resume-projects>\n    </div>\n  </div>\n  <resume-footer></resume-footer>\n</div>\n"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.setSkillHeight = function (skillHeight) {
...
module.exports = "<div #sideProjectElm style=\"border:1px solid transparent;\">\n  <div class=\"card text-black bg-info mb-3 project-header\"  >\n    <div class=\"card-body\">\n      <h4 class=\"card-title\">Global Game Jam <span style=\"font-size:14px\">Projects</span></h4>\n    </div>\n  </div>\n</div>\n<div *ngIf=\"sideProjectsFixed\" class=\"card text-black bg-info mb-3 project-header side-projects-fixed\" >\n  <div class=\"card-body\">\n    <h4 class=\"card-title\">Global Game Jam <span style=\"font-size:14px\">Projects</span></h4>\n  </div>\n</div>\n\n<div class=\"side-projects\" style=\"border:1px solid transparent;\">\n  <project-component [projects]=\"sideProjects\"></project-component>\n</div>\n\n<div #courseProjectElm style=\"border:1px solid transparent;\">\n  <div class=\"card text-black bg-info mb-3 project-header course-projects-header\">\n    <div class=\"card-body\">\n      <h4 class=\"card-title\">Course <span style=\"font-size:14px\">Projects</span></h4>\n    </div>\n  </div>\n</div>\n<div *ngIf=\"courseProjectsFixed\" class=\"card text-black bg-info mb-3 project-header course-projects-fixed\">\n  <div class=\"card-body\">\n    <h4 class=\"card-title\">Course <span style=\"font-size:14px\">Projects</span></h4>\n  </div>\n</div>\n<div class=\"course-projects\" style=\"border:1px solid transparent;\">\n  <project-component [projects]=\"courseProjects\" [carousel-background]=\"'black'\"></project-component>\n</div>"
...
var ProjectsComponent = /** @class */ (function () {
    function ProjectsComponent(http, elmRef) {
        this.http = http;
        this.elmRef = elmRef;
        this.courseProjects = [];
        this.sideProjects = [];
    ...
    Object.defineProperty(ProjectsComponent.prototype, "parentHeight", {
        set: function (value) {
    ...
    ProjectsComponent.prototype.onWindowScroll = function () {
        ...
        var headerHeight = 90;
        var headerPos = this._parentHeight;
        ...
        var compiledHeight1 = headerPos;
        var compiledHeight2 = headerPos + this.sideProjectsHeight + this.sideProjectElm.nativeElement.offsetHeight;
    ...
    ProjectsComponent.prototype.onWindowResize = function () {
        this.sideProjectsHeight = undefined;
        this.courseProjectsHeight = undefined;
        this.onWindowScroll();
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* ViewChild */])('sideProjectElm'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */])
    ], ProjectsComponent.prototype, "sideProjectElm", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* ViewChild */])('courseProjectElm'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */])
    ], ProjectsComponent.prototype, "courseProjectElm", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])('offsetHeight'),
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], ProjectsComponent.prototype, "parentHeight", null);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* HostListener */])("window:scroll", []),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
    ...
    __decorate([
        ...
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", void 0)
    ], ProjectsComponent.prototype, "onWindowResize", null);
    ProjectsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */]])
    ], ProjectsComponent);
...
module.exports = "<div class=\"height-fix\" style=\"border:1px solid transparent;\">\n  <div class=\"skills-container\">\n      <nav class=\"skill-color-override navbar navbar-expand-lg navbar-dark bg-dark\">\n        <a class=\"navbar-brand\" href=\"#\">DanCan</a>\n        <button #skillNav class=\"navbar-toggler collapsed\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarTOP\" aria-controls=\"navbarTOP\" aria-expanded=\"true\" aria-label=\"Toggle navigation\">\n          <span class=\"navbar-toggler-icon\"></span>\n        </button>\n\n        <div class=\"navbar-collapse collapse\" id=\"navbarTOP\" >\n          <!-- <ng-container *ngFor=\"let skill of skills\"> -->\n            <navigate-skill [offset]=\"280\" (navigationClick)=\"collapse()\" [text]=\"'skill'\"></navigate-skill>\n          <!-- </ng-container> -->\n        </div>\n      </nav>\n  </div>\n</div>\n<div *ngIf=\"showHeader\" class=\"skills-header\">\n  <div class=\"center-sides\">\n    <nav class=\"skill-color-override navbar navbar-expand-lg navbar-dark bg-dark\">\n      <a class=\"navbar-brand\" href=\"#\">DanCan</a>\n      <button #skillNavFloat class=\"navbar-toggler collapsed\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarColor03\" aria-controls=\"navbarColor03\" aria-expanded=\"true\" aria-label=\"Toggle navigation\">\n        <span class=\"navbar-toggler-icon\"></span>\n      </button>\n\n      <div class=\"navbar-collapse collapse\" id=\"navbarColor03\">\n        <!-- <ng-container *ngFor=\"let skill of skills\"> -->\n        <navigate-skill [offset]=\"200\" (navigationClick)=\"collapse()\" [text]=\"'skill'\"></navigate-skill>\n        <!-- </ng-container> -->\n      </div>\n    </nav>\n  </div>\n</div>\n"
...
var SkillsComponent = /** @class */ (function () {
    function SkillsComponent(contactsService, elmRef) {
        ...
        this.headerHeight = 0;
        this.skillHeight = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* EventEmitter */]();
    }
    ...
    SkillsComponent.prototype.onWindowScroll = function () {
        var number = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0;
        var headerPos = this._parentHeight - this.headerHeight;
        if (number > headerPos) {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["P" /* Output */])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* EventEmitter */])
    ], SkillsComponent.prototype, "skillHeight", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["y" /* HostListener */])("window:scroll", []),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
